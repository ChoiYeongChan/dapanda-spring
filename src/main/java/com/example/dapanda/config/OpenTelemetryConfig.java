package com.example.dapanda.config;
...
public class OpenTelemetryConfig {
    ...
    SdkLoggerProvider otelSdkLoggerProvider(Environment environment, ObjectProvider<LogRecordProcessor> logRecordProcessors) {
        String applicationName = environment.getProperty("spring.application.name", "dapanda");
        ...
        return BatchLogRecordProcessor
                .builder(
                        OtlpGrpcLogRecordExporter.builder()
                                .setEndpoint("http://opentelemetry-collector.istio-system.svc.cluster.local:4317")
                                .build())
                .build();
    }
    ...
    SdkTracerProvider sdkTracerProvider() {
        return SdkTracerProvider.builder()
                .setResource(Resource.create(Attributes.of(ResourceAttributes.SERVICE_NAME, "dapanda")))
